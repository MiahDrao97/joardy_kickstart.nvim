...
M.descend_to_the_underworld = function()
  ...
  vim.api.nvim_set_hl(0, '@none.c_sharp', { link = '@keyword' })
  ...
  vim.api.nvim_set_hl(0, '@keyword.directive.c_sharp', { fg = colors.comment_grey })
  ...
  vim.api.nvim_set_hl(0, '@function.call.zig', { fg = colors.eyesore_pink })
